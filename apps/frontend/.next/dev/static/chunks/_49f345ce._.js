...
"[project]/apps/frontend/node_modules/detect-gpu/dist/detect-gpu.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function r(e) {
    return e = e.toLowerCase().replace(/^angle ?\((.+)\)*$/, "$1").replace(/\s(\d{1,2}gb|direct3d.+$)|\(r\)| \([^)]+\)$/g, "").replace(/(?:vulkan|opengl) \d+\.\d+(?:\.\d+)?(?: \((.*)\))?/, "$1");
}
...
function d(e, t) {
    ...
    let a, d = 0;
    for(; d < n && e.charCodeAt(d) === t.charCodeAt(d);)d++;
    if (n -= d, o -= d, 0 === n) return o;
    let l, s, f = 0, u = 0, h = 0;
    for(; u < n;)c[u] = e.charCodeAt(d + u), i[u] = ++u;
    for(; h < o;)for(a = t.charCodeAt(d + h), l = h++, f = h, u = 0; u < n; u++)s = a === c[u] ? l : l + 1, l = i[u], f = i[u] = l > f ? s > f ? f + 1 : s : s > l ? l + 1 : s;
    return f;
}
function l(e) {
    return null != e;
...
const f = ({ mobileTiers: i = [
    ...
    30,
    60
], override: f = {}, glContext: u, failIfMajorPerformanceCaveat: h = !1, benchmarksURL: g = "https://unpkg.com/detect-gpu@4.0.50/dist/benchmarks" } = {})=>e(void 0, void 0, void 0, function*() {
        const p = {};
        if (n) return {
            tier: 0,
            type: "SSR"
        ...
        const { isIpad: m = !!(null == o ? void 0 : o.isIpad), isMobile: v = !!(null == o ? void 0 : o.isMobile), screenSize: w = window.screen, loadBenchmarks: x = (t)=>e(void 0, void 0, void 0, function*() {
                ...
                if (parseInt(e.shift().split(".")[0], 10) < 4) throw new s("Detect GPU benchmark data is out of date. Please update to version 4x");
                return e;
            }) } = f;
        let { renderer: A } = f;
        const P = (e, t, r, n, o)=>({
        ...
        if (A) A = r(A), b = [
            ...
            if (t && (A = e.getParameter(t.UNMASKED_RENDERER_WEBGL)), !A) return P(1, "FALLBACK");
            S = A, A = r(A), b = function(e, t, r) {
        ...
        const y = (yield Promise.all(b.map(function(t) {
            ...
            return e(this, void 0, void 0, function*() {
                ...
                let c = a.filter(([, e])=>e === i);
                c.length || (c = a.filter(([e])=>e.includes(t)));
                const l = c.length;
                if (0 === l) return;
                let f, [u, , , h] = l > 1 ? c.map((e)=>[
                        e,
                        d(t, e[0])
                    ]).sort(([, e], [, t])=>e - t)[0][0] : c[0], g = Number.MAX_VALUE;
                const { devicePixelRatio: A } = window, P = w.width * A * w.height * A;
                for (const e of h){
                    const [t, r] = e, n = t * r, o = Math.abs(P - n);
                    o < g && (g = o, f = e);
                }
                if (!f) return;
                const [, , b, S] = f;
        ...
        }))).filter(l).sort(([e = Number.MAX_VALUE, t], [r = Number.MAX_VALUE, n])=>e === r ? t - n : e - r);
        if (!y.length) {
...
//# sourceMappingURL=_49f345ce._.js.map