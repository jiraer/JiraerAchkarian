...
// Dynamically import the LabScene inside the Client Component
const LabScene = dynamic(() => import('../../components/lab/LabScene').then((m) => m.LabScene), { ssr: false });
